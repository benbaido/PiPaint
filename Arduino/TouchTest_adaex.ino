...
#define LED_MATRIX_MINX 0
#define LED_MATRIX_MINY 0
#define LED_MATRIX_MINZ 0

#define LED_MATRIX_MAXX 32
#define LED_MATRIX_MAXY 16
#define LED_MATRIX_MAXZ 7
  ...
  if (touch.touched()) {
    ...
    while (! touch.bufferEmpty()) {
      ...
      */
      ...
      //*
      p.x = map(p.x, TS_MINX, TS_MAXX, LED_MATRIX_MINX, LED_MATRIX_MAXX);
      p.y = map(p.y, TS_MINY, TS_MAXY, LED_MATRIX_MINY, LED_MATRIX_MAXY);
      p.z = map(p.z, TS_MINZ, TS_MAXZ, LED_MATRIX_MINZ, LED_MATRIX_MAXZ);
